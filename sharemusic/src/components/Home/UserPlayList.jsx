    ...
    songs.map((song) => {
      ...
      jsmediatags.read(song, {
        onSuccess:  (tag)=> {
          ...
          var userid = fire.auth().currentUser.uid;
          storageRef.child("users/" + userid + "/songs/" + song.name).put(song,songmetadata).then( (snapshot) =>{
